...
BULLET_DAMAGE_FIREBALL_BODY = 20 # 这是火球本体的伤害，注意不是40，本体(27) + 溅射(13)才是40
...
# 僵尸生命值设置
# 有关本体
NORMAL_HEALTH = 350 # 普通僵尸生命值
POLE_VAULTING_HEALTH = 550
ZOMBONI_HEALTH = 1780
# 冰车损坏点
...
# 有关一类防具
CONEHEAD_HEALTH = 1400
BUCKETHEAD_HEALTH = 1800
FOOTBALL_HELMET_HEALTH = 2500
# 有关二类防具
NEWSPAPER_HEALTH = 250
SCREEN_DOOR_HEALTH = 1500

# 僵尸行动信息
ATTACK_INTERVAL = 130
ZOMBIE_ATTACK_DAMAGE = 124
ZOMBIE_WALK_INTERVAL = 13  # 僵尸步行间隔
...
CREATE_ZOMBIE_DICT = {  # 生成僵尸:(级别, 权重)
                NORMAL_ZOMBIE:                  (5, 4000),
                FLAG_ZOMBIE:                    (3, 1110),
                CONEHEAD_ZOMBIE:                (2, 4000),
                BUCKETHEAD_ZOMBIE:              (2, 3000),
                NEWSPAPER_ZOMBIE:               (2, 2000),
                FOOTBALL_ZOMBIE:                (1, 3000),
                DUCKY_TUBE_ZOMBIE:              (2, 4000), # 作为变种，不主动生成
                CONEHEAD_DUCKY_TUBE_ZOMBIE:     (2, 2500), # 作为变种，不主动生成
                BUCKETHEAD_DUCKY_TUBE_ZOMBIE:   (4, 3000), # 作为变种，不主动生成
                SCREEN_DOOR_ZOMBIE:             (4, 3500),
                POLE_VAULTING_ZOMBIE:           (2, 2000),
                ZOMBONI:                        (3, 2000),
                SNORKELZOMBIE:                  (2, 2000),
}
